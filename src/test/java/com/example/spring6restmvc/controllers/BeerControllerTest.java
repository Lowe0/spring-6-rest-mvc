...
class BeerControllerTest {
    ...
    void getAllBeers() throws Exception {
        ...
        verify(beerService).listBeers(null);
    }

    @Test
    void getBeerById() throws Exception {
        BeerDto testBeer = beerServiceImpl.listBeers(null).iterator().next();
    ...
    void addBeer() throws Exception {
        BeerDto beer = beerServiceImpl.listBeers(null).iterator().next();
        beer.setVersion(null);
        beer.setId(null);

        given(beerService.addBeer(any(BeerDto.class))).willReturn(beerServiceImpl.listBeers(null).iterator().next());
